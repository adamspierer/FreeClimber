...
class DectFrame(wx.Frame):    
    def __init__(self, parent, file_path):
        ...
        'vvars','naming_convention','path_project','file_suffix','convert_to_cm'] #'frame_n',
        ...
        self.input_values = [self.input_x,self.input_y,self.input_w,self.input_h,
                             ...
                             self.input_file_suffix,self.input_convert_to_cm] # self.input_frame_n
...
# #             raise SystemExit
#             os.system('python ./FreeClimber_main.py %s False' % (self.path_parameters)) ## HELP
#         finally:
...
def define_argument_parser():
    ...
    parser.version = '0.3' ## Program version
...
wxID_vert_line_1] = [wx.NewId() for _init_controls in range(52)] # wxID_run_analysis,wxID_input_frame_n,
